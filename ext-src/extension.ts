...
class WebPanel {
  ...
  private constructor(extensionPath: string, column: vscode.ViewColumn) {
    ...
    this.panel = vscode.window.createWebviewPanel(WebPanel.viewType, 'Theme Builder', column, {
...
export function activate(context: vscode.ExtensionContext) {
  vscode.window.registerTreeDataProvider('themebuilder-webview', new TargetTreeProvider());

  context.subscriptions.push(
    vscode.commands.registerCommand('themebuilder-webview.openWebview', () => {
